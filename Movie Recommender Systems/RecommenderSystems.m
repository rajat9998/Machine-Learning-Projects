...
%  To help to debug cost function, we have included set of weights
...
%  Once the cost function matches up, we should now implement 
...
%  Once the cost matches up, you should proceed to implement 
