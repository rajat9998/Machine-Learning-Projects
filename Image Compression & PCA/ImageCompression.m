...
%  Here we will use K-Means to compress an image. To do this, we will 
...
%  Here, we will use the clusters of K-Means to compress an image. 
%  To do this, we will first find the closest clusters for
%  each example.
